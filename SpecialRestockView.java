...
public class SpecialRestockView extends JPanel implements InventoryObserver, SpecialInventoryObserver {
    ...
    public SpecialRestockView(SpecialRestockModel model) {
        this.model = model;
    ...
    public void updateButton(int row, int col, SpecialItem item) {
        if (item != null) {
            buttons[row][col].setText("<html>Name: " + item.getName() + "<br>Quantity: " + model.getQuantity(row, col) + "<br>Cost: " + item.getCost() + "<br>Calories: " + item.getCalories() + "</html>");
        } else {
